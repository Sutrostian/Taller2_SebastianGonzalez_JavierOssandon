...
public class Habitat {
	...
	public Pokemon AparicionPokemon(Habitat h) {
		// Los comentarios aqui seran para explicar el razonamiento detras del spawn de
		// los pokemons
		// lo primero que tenemos que saber es que la probabilidad de spawn de los
		// pokemons en el bioma deben sumar 1
		// por lo tanto usaremos probabilidad acumulada para determinar el pokemon que
		// spawnea
		...
		// ahora verificaremos si r<=Pacumulada diremos que ese es nuestro pokemon que
		// spawnea en este caso no aparece
		// entonces veremos el siguiente pokemon
		// diremos pokemon 2 tiene probabilidad de 0.2
		// probabilidad acumulada = 0.5+0.2 = 0.7
		// como nuestro random era 0.75 y r no es menor que p acumulado revisamos el
		// siguiente pokemon
		...
		Random rand = new Random();// nota para seba, el random funciona como un scanner por asi decirlo entonces
									// creamos nuestro generador de randoms
